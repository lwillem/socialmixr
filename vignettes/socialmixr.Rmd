...
The `contact_matrix()` allows to specify and use your own weights. Therefore, provide the weight columns names as `participant.weights`.

```{r message=FALSE, warning=FALSE}
# e.g. use household size as (dummy) weight
contact_matrix(survey = polymod, age.limits = c(0,18,60), participant.weights = c('hh_size'))
```
